"""New tables: ecosystems, packages, and versions.
...
def downgrade():
    ...
    op.add_column('analysis_requests', sa.Column('ecosystem', sa.INTEGER(), autoincrement=False,
                  nullable=True))
    ...
    op.add_column('analyses', sa.Column('version', sa.VARCHAR(length=255), autoincrement=False,
                  nullable=True))
    op.add_column('analyses', sa.Column('ecosystem', sa.INTEGER(), autoincrement=False,
                  nullable=True))
    op.add_column('analyses', sa.Column('package', sa.VARCHAR(length=255), autoincrement=False,
                  nullable=True))
